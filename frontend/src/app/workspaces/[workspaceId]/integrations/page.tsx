                            ...
                            <ItemActions className="ml-auto flex shrink-0 items-center gap-1.5 pl-3">
                              ...
                              {showConnect && (
                                <>
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    className="h-6 border-input px-2.5 text-[11px] text-foreground hover:bg-muted"
                                    onClick={(event) => {
                                      event.stopPropagation()
                              ...
                              {showDisconnect && (
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className="h-6 border-input px-2.5 text-[11px] text-foreground hover:border-destructive hover:bg-destructive hover:text-destructive-foreground"
                                  onClick={(event) => {
                                    event.stopPropagation()
                                    setDisconnectTarget({
                                      providerId: item.id,
